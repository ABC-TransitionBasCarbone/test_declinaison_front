...
import type { DottedName, FunFacts } from '@abc-transitionbascarbone/test_declinaison_modele'
import importedFunFacts from '@abc-transitionbascarbone/test_declinaison_modele/public/funFactsRules.json'
